      ...
      >
        ...
        >
          <ul className="space-y-1.5">
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
                href="/Dashboard"
              >
                <House />
            ...
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Campaigns" || pathname === "/Dashboard/Campaigns/CreateEmailCampaign" || pathname === "/Dashboard/Campaigns/EditEmailCampaign" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
            ...
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Contacts" || pathname === "/Dashboard/Contacts/new" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
            ...
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Domains" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
            ...
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Survey" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
                href="/Dashboard/Survey"
              >
                <Cctv />
                <p className="text-sm">Survey</p>
              </Link>
            </li>

            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Subscription" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
            ...
            <li>
              <Link
                className={`flex items-center gap-x-3.5 py-2 px-2.5 ${pathname === "/Dashboard/Setting" ? "dark:bg-white dark:text-gray-900" : "text-neutral-700  dark:text-gray-300"} text-sm rounded-lg`}
