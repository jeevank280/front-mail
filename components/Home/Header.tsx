...
export default function Header() {
  ...
  console.log("user from harder: ", user);
        ...
        >
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7">
              ...
              {user ? (
                <Link
                  className="flex ml-4 items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 md:border-s md:border-gray-300 py-2 md:py-0 md:my-6 md:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500"
                  href="/Dashboard"
                >
                  <svg
